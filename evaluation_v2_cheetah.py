...
# 1. Generate trajectories
    ...
    traj_states, traj_actions, total_rewards = mpc._MPC__sampleTraj_TrueEnv(state)
    traj_next_states = traj_states[:, 1:]
...
def evaluate(mpc, num_episodes=10):
    ...
    for episode in range(num_episodes):
        ...
        for i in range(env_target.spec.max_episode_steps):
            ...
            a0_target, best_reward, index = mpc._MPC__decodeTraj(s, a)
    ...
    return avg_reward1, avg_best_reward
...
if __name__ == '__main__':
    ...
    total_reward1, best_rewards = evaluate(mpc)
